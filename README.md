...
```sh
git clone https://github.com/<YOUR_ORG>/jira-mcp.git
cd jira-mcp
make build
make test
```
...
- **GitHub Issues**: [Create an issue](https://github.com/<YOUR_ORG>/jira-mcp/issues)
- **Discussions**: [Start a discussion](https://github.com/<YOUR_ORG>/jira-mcp/discussions)
